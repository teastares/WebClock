#basic url of Tsinghua Web Courses
base = 'https://learn.tsinghua.edu.cn'

#url to login the Web Courses
login = base + '/MultiLanguage/lesson/teacher/loginteacher.jsp'

#url for the course list
courses = base + '/MultiLanguage/lesson/student/MyCourse.jsp?language=cn'
